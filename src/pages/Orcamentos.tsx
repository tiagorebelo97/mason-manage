    ...
    <div className="container mx-auto py-8 px-4">
      <div className="mb-8 space-y-3">
        <div className="flex items-center justify-between mb-2">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">{t('orcamento.title')}</h1>
          
          <Button onClick={() => setIsOrcamentoDialogOpen(true)} size="lg" className="shadow-lg">
            <Plus className="mr-2 h-4 w-4" />
            {t('orcamento.addOrcamento')}
          </Button>
        </div>
        <p className="text-base text-muted-foreground">{t('orcamento.subtitle')}</p>
      </div>
