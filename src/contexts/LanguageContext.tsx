...
const translations = {
  en: {
    ...
    'orcamento.aiAnalyze': 'AI Analyze',
    'orcamento.aiAnalyzing': 'AI Analyzing...',
    'orcamento.aiAnalyzeSuccess': 'File analyzed successfully with AI',
    'orcamento.aiAnalyzeError': 'Failed to analyze file with AI',
    'orcamento.aiAnalyzeDescription': 'Use AI to better understand and analyze the Excel file',
    'orcamento.loadingData': 'Loading data...',
    'orcamento.pleaseWait': 'Please wait while we load the analyzed data',
    'orcamento.noDataFound': 'No data found',
    'orcamento.analyzeAgain': 'The file was analyzed but no data was found. Please try uploading a different file or check the file format.',
  ...
  pt: {
    ...
    'orcamento.aiAnalyzeSuccess': 'Ficheiro analisado com sucesso com IA',
    'orcamento.aiAnalyzeError': 'Falha ao analisar ficheiro com IA',
    'orcamento.aiAnalyzeDescription': 'Use IA para entender e analisar melhor o ficheiro Excel',
    'orcamento.loadingData': 'A carregar dados...',
    'orcamento.pleaseWait': 'Por favor aguarde enquanto carregamos os dados analisados',
    'orcamento.noDataFound': 'Nenhum dado encontrado',
    'orcamento.analyzeAgain': 'O ficheiro foi analisado mas não foram encontrados dados. Por favor tente carregar um ficheiro diferente ou verifique o formato do ficheiro.',
