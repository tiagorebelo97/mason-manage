...
const translations = {
  en: {
    ...
    'dialog.addSpecialityDesc': 'Add a new construction speciality type. Translation will be done automatically.',
  ...
  pt: {
    ...
    'dialog.addSpecialityDesc': 'Adicionar um novo tipo de especialidade de construção. A tradução será feita automaticamente.',
